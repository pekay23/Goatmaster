...
* Application refers to Goat Master, the software program provided by the
    Company.

* Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Agreement) refers to Goat Master.
...
* Website refers to Goat Master, accessible from
    [https://goatmaster.created.app/](https://goatmaster.created.app/)
...
User-Generated Content (Goat Data): This includes all proprietary information you enter into the Application for the purpose of herd management, such as Goat Names, IDs, Breed information, Birth Dates, Weight Records, Health Logs, Medication Records, Breeding/Kidding Records, and general Notes.
...
**We engage third-party companies to facilitate our Service ("Service Providers"), to provide the Service on our behalf, and to perform Service-related services. We may disclose your Personal Data to the following types of Service Providers:**

* **Analytics Providers: For monitoring and analyzing the use of our Service and to improve user experience (e.g., Google Analytics, Firebase Analytics).**
* **Hosting/Cloud Storage Providers: For secure database hosting and storage of user-uploaded data, including goat photos (e.g., the cloud services provider used by CreateAnything).**
* **Customer Support/Communication Providers: For managing user requests and contact (e.g., a help desk software).**
...
* By email: samuel.hughes.23@outlook.com

* By phone: +233554416937
